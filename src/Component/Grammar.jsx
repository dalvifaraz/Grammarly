  ...
  const check = async () => {
    try {
      const response = await fetch(
        `https://api.textgears.com/spelling?text=${text}&language=en-GB&whitelist=&dictionary_id=&key=UVgdh8Eniw0UaJQY`
      );
    ...
    <div id='container'>
      <div id='textdiv' className='textclass'>
        <textarea
          ...
          maxLength={150}
        ></textarea>
        <button className='btn btn-primary' id='btn1' onClick={handleClick}>
